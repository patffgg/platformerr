...
levels = [
    ...
    pygame.Rect(1900, 300, 250, 20),
    pygame.Rect(2200, 250, 200, 20),
    pygame.Rect(2600, 350, 200, 20),
    pygame.Rect(2900, 350, 100, 20),
...
"enemies": [
    ...
    {"rect": pygame.Rect(2200, 210, 40, 40), "dir": -1, "range": (2200, 2360)},
    {"rect": pygame.Rect(2900, 310, 40, 40), "dir": -1, "range": (2900, 2960)},
